...
static char *help_msg[] = {
		"Welcome to FlatDraw!\nThis program allows you to create drawings and sketches.\nTo get help, go to the <a href=\"https://github.com/Centrix14/fd/blob/master/doc/user_manual.md\">website</a>\nDocumentation is <a href=\"https://github.com/Centrix14/fd/blob/master/doc/fd_doc.md\">here</a>\nFLatDraw v0.15 by Centrix14 13.12.2020",
		"Select point",
		"Select start point",
		"Select end point",
		"Select center point",
